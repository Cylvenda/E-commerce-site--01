        ...
        while($row=mysqli_fetch_assoc($result))
        {
          ...
          echo '<div class="col-md-3">
                  <div class="product-tab-tab">
                    ...
                    <a href="add_to_order?product='.$product_id.'" class="btn btn-block btn-success" >Order Now </a>
                    <a href="delete_from_cart?product='.$product_id.'" class="btn btn-block btn-danger" >Remove from Cart </a>
